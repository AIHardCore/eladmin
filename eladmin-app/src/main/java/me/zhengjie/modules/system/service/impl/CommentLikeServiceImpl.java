...
public class CommentLikeServiceImpl implements CommentLikeService {
    ...
    @Override
    public CommentLikeDto findCommentLikeByKey(CommentLike.CompositeKey key) {
        CommentLike commentLike = commentLikeRepository.findCommentLikeByKey(key);
        ValidationUtil.isNull(commentLike.getKey().getId(),"CommentLike","key",key);
    ...
    @Override
    public void delete(CommentLikeDto commentLike) {
        commentLikeRepository.delete(commentLikeMapper.toEntity(commentLike));
    }
