...
public interface SectionService {
    ...
    */
    PageResult<SectionDto> queryAll(SectionQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<SectionDto> queryAll(SectionQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<SectionDto> all, HttpServletResponse response) throws IOException;
}
